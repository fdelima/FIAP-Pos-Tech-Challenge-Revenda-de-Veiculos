...
internal class VeiculoPagamentoMap : IEntityTypeConfiguration<VeiculoPagamentoEntity>
{
    public void Configure(EntityTypeBuilder<VeiculoPagamentoEntity> builder)
    {
