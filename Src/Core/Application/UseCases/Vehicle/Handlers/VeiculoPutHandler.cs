...
{
    public class VeiculoPutHandler : IRequestHandler<VeiculoPutCommand, ModelResult<Veiculo>>
    {
        ...
        public async Task<ModelResult<Veiculo>> Handle(VeiculoPutCommand command, CancellationToken cancellationToken = default)
        {
